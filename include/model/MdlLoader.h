...
private:
	static void LoadMaterial(const ur::Device& dev, const MdlHeader& header, std::ifstream& fin, Model& model, const std::string& filepath);
	static void LoadMesh(const ur::Device& dev, const MdlHeader& header, std::ifstream& fin, Model& model);
